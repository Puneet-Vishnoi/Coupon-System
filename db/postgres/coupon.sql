...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_type WHERE typname = 'usage_type') THEN
        ...
        ALTER TABLE coupons
            ...
            ALTER COLUMN usage_type SET DEFAULT 'single_use';
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_type WHERE typname = 'discount_target') THEN
        ...
        ALTER TABLE coupons
            ...
            ALTER COLUMN discount_target SET DEFAULT 'total_order_value';
...
CREATE TABLE IF NOT EXISTS coupons (
    ...
    usage_type usage_type NOT NULL DEFAULT 'single_use',
    ...
    discount_target discount_target NOT NULL DEFAULT 'total_order_value',
